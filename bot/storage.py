...
CUSTOM_TEXTS = {
    ...
    "token_ok": {
        ...
        "default": (
            ...
            "━━━━━━━━━━━━━━\n"
            "🚀 <b>Шаг 2 из 2 — открыть остальное</b>\n\n"
            "Одного токена мало: Юмаркет не даёт через API то, что приносит "
            "деньги напрямую. Вход в панель включает:\n\n"
            "🆕 <b>Создание товаров</b> — новая позиция за минуту, из Telegram\n"
            "⭐️ <b>Премиум-продвижение</b> — выделение и поднятие объявлений\n"
            "💸 <b>Вывод средств</b> — заработанное на карту, СБП или крипту\n"
            "🛟 <b>Ответы в поддержку</b> — прямо здесь, не открывая сайт\n\n"
