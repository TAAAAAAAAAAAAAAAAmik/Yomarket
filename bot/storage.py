...
_WHAT_I_DO = (
    "⚡️ <b>Приму заказ за секунды</b> — хоть в четыре утра\n"
    "💬 <b>Отвечу покупателю сразу</b> — пока он не убежал к соседу\n"
    "🔄 <b>Верну распроданное на витрину</b> — чтобы она не простаивала\n"
    "⭐️ <b>Выдам звёзды сам</b> — тебя дёргать не буду\n"
    "🔔 <b>Замечу жалобу первым</b> — до арбитража, а не после\n"
    "📊 <b>Посчитаю выручку и чистыми</b> — каждый вечер, без таблиц"
)
