...
_TOKEN_HOWTO = (
    "🔑 <b>Шаг 1 из 2 — API-токен магазина</b>\n\n"
    "Он нужен, чтобы бот видел ваши заказы, товары и баланс.\n\n"
    "<b>Где его взять:</b>\n"
    "1️⃣ Откройте <a href=\"https://panel.yoomarket.net\">panel.yoomarket.net</a>\n"
    "2️⃣ Слева — <b>Мой магазин</b>\n"
    "3️⃣ Вкладка <b>Интеграции</b>\n"
    "4️⃣ Нажмите <b>Создать токен</b> и скопируйте его\n\n"
    "📋 Пришлите токен сюда одним сообщением.\n\n"
    "<i>🔒 Токен хранится только у вас в боте и никуда не передаётся.</i>"
)
...
CUSTOM_TEXTS = {
    "welcome": {
        ...
        "default": (
            ...
            "Я помогу вам управлять магазином на Юмаркете: заказы, товары, "
            "чаты, продвижение и вывод средств — из Telegram.\n\n"
            + _TOKEN_HOWTO
        ),
    },
    "token_ok": {
        ...
        "default": (
            ...
            "💰 Баланс: <b>{balance} ₽</b>\n\n"
            "━━━━━━━━━━━━━━\n"
            "🌐 <b>Шаг 2 из 2 — вход в панель</b>\n\n"
            "Токен даёт заказы и товары. Вход в панель добавляет то, чего в API "
            "нет: <b>создание товаров</b>, <b>продвижение</b>, <b>вывод средств</b> "
            "и <b>ответы в поддержку</b>.\n\n"
    ...
    "sub_granted": {
        ...
        "default": (
            ...
            "Спасибо за доверие — доступ открыт на <b>{days} дн.</b> "
            "(всего осталось <b>{left} дн.</b>).\n\n"
            "Осталось подключить магазин — это две минуты.\n\n"
            "━━━━━━━━━━━━━━\n"
            + _TOKEN_HOWTO
        ),
    },
