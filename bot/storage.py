...
_WHAT_I_DO = (
    "💬 <b>Покупатель.</b> Отвечу на сообщение сразу, напишу при заказе и "
    "возврате, замечу жалобу до арбитража\n"
    "📦 <b>Заказы.</b> Возьму в работу и подтвержу — хоть в четыре утра, "
    "напомню о зависших\n"
    "🚀 <b>Объявления в топе.</b> Слежу за позицией и поднимаю, как только "
    "просядешь: «Премиум» по расписанию, паки целиком, возврат "
    "распроданного. Восстановлю снятые, выложу новые\n"
    "🧩 <b>Выдача без тебя.</b> {карт} гифт-карт и Telegram Stars — код "
    "уходит покупателю за секунды, в любое время суток\n"
    "📊 <b>Деньги.</b> Выручка и чистыми каждый вечер, порог баланса, "
    "новые отзывы\n"
    "⚡️ <b>Из Telegram.</b> «Автопилот» включает рабочий набор одной "
    "кнопкой, магазинов можно несколько, ставить нечего"
)
...
CUSTOM_TEXTS = {
    "welcome": {
        ...
        "default": (
            "👋 Привет! Я — YooMarket.\n\n"
            "Пока ты спишь, кто-то оформляет заказ в твоём магазине и ждёт "
            "ответа. Не дождался за час — ушёл к тому, кто ответил быстрее. "
            "Вот эти часы я и закрываю.\n\n"
            + _WHAT_I_DO + "\n\n"
            "<b>Рутина на мне. Продажи твои.</b>\n\n"
            "━━━━━━━━━━━━━━\n"
            "🆓 <b>Бесплатно:</b> подключить магазин и получать уведомления "
            "о заказах.\n"
            "💳 <b>Подписка{цена}</b> — автоответы, автовыдача, продвижение, "
            "вывод средств.\n\n"
            "🎁 <b>{проба} дня</b> — просто так  ·  📣 <b>+{неделя} дней</b> "
            "— за подписку на канал\n"
            "<i>Берётся и то, и другое, по разу: {всего} дней бесплатно.</i>"
        ),
    },
    "connect": {
