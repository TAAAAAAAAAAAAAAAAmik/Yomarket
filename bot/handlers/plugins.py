...
def _plugins_menu_text(settings: dict, shop_name: str = "") -> str:
    ...
    return "\n".join([
        ...
        "",
        "Покупатель оплатил — бот сам купил код у поставщика и отправил "
        "его в чат заказа. Без вас.",
        "",
        "🌙 Ночью и в выходные — заказы не ждут вас",
        "⏱ Ни поставщика, ни копирования кодов вручную",
        "⭐ Код за секунды — за скорость и платят",
        "🎁 Карт много: Apple, Xbox, Steam, PlayStation, Roblox, Amazon…",
    ])
